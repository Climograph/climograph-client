export default function ClimaticaLogo({ className }: { className?: string }) {
  return (
    <svg
      ...
      className={className}
    >
      <rect y="691" width="295" height="531" rx="40" fill="#9FE1CB" />
      <path
      ...
      <path
        ...
        fill="#5DCAA5"
      />
      <rect x="771" y="28" width="295" height="1194" rx="40" fill="#1D9E75" />
      <ellipse cx="148" cy="529.5" rx="105" ry="105.5" fill="#0F6E56" />
      <path
      ...
      <path
        ...
        fill="#0F6E56"
      />
      <ellipse cx="533" cy="230.5" rx="105" ry="104.5" fill="#0F6E56" />
      <path
